...
import com.fitibo.aotearoa.vo.HotItemVo;
...
public final class ObjectParser {
    ...
    public static HotItemVo parse(HotItem hotItem) {
        HotItemVo result = new HotItemVo();
        result.setCreateOrderUrl("create_order?uuid=" + hotItem.getSkuUuid());
        result.setLookupUrl(hotItem.getLookupUrl());
        result.setSku(hotItem.getSku());
        result.setSkuUuid(hotItem.getSkuUuid());
        return result;
    }
}
