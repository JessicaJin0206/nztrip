CREATE TABLE IF NOT EXISTS `nztrip`.`agent` (
...
CREATE TABLE IF NOT EXISTS `nztrip`.`category` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `nztrip`.`city` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`))
  ENGINE = InnoDB;

CREATE TABLE IF NOT EXISTS `nztrip`.`order` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `sku_id` INT NOT NULL,
  `agent_id` INT NOT NULL,
  `remark` TEXT(1000) NOT NULL COMMENT 'store in son format according to sku_remark',
  ...
  `price` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `sku_id_idx` (`sku_id` ASC))
  ENGINE = InnoDB;

CREATE TABLE IF NOT EXISTS `nztrip`.`sku` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `nztrip`.`sku_price` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `sku_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `nztrip`.`sku_remark` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `sku_id` INT NOT NULL,
